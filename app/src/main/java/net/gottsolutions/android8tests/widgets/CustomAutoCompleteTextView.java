...
public class CustomAutoCompleteTextView extends EditText implements Filter.FilterListener {
    ...
    static final String TAG = CustomAutoCompleteTextView.class.getName();
    ...
    private CustomListPopupWindow mPopup;
    ...
    public CustomAutoCompleteTextView(
        ...
        mPopup = new CustomListPopupWindow(context, attrs, defStyleAttr, defStyleRes);
    ...
    private void performCompletion(View selectedView, int position, long id) {
        if (isPopupShowing()) {
            ...
            if (mItemClickListener != null) {
                final CustomListPopupWindow list = mPopup;
     ...
     * @see CustomAutoCompleteTextView#setOnDismissListener(OnDismissListener)
     */
    ...
    private static class PopupDataSetObserver extends DataSetObserver {
        private final WeakReference<CustomAutoCompleteTextView> mViewReference;

        private PopupDataSetObserver(CustomAutoCompleteTextView view) {
            mViewReference = new WeakReference<CustomAutoCompleteTextView>(view);
        }

        @Override
        public void onChanged() {
            final CustomAutoCompleteTextView textView = mViewReference.get();
